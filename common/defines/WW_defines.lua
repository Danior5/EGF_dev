...
NGame = {
	#GAME_SPEED_SECONDS = { 0.2, 0.2, 0.15, 0.1, 0.0 } -- game speeds for each level. Must be 5 entries with last one 0 for unbound
	COMBAT_LOG_MAX_MONTHS = 36
	LAG_DAYS_FOR_LOWER_SPEED = 50					-- Days of client lag for decrease of gamespeed
...
NMilitary = {
	...
	UNIT_EXP_LEVELS = {0.02,	0.04,	0.06,	0.08,	0.1,	0.14,	0.18,	0.22,	0.26,	0.3}		-- Experience needed to progress to the next level
},
...
NDiplomacy = {
	VOLUNTEERS_DIVISIONS_REQUIRED = 0 -- Divs required to send volunteers
	TENSION_DECAY = 0.1 -- default 0.1, changed from 0.25 in EaW vanilla
	MP_NUM_WINNERS_FOR_PEACE_PAUSE = 2				-- Number of human players as winners needed for peace conference to pause and open for everyone in multiplayer, needs to fullfill MP_NUM_LOSERS_FOR_PEACE_PAUSE as well.
...
NTechnology = {
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 2	-- Base year ahead penalty. Vanilla is 2. Changed back to 2 from 2.5 in vanilla EaW
},
}